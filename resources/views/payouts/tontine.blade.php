<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('tontines.show', $tontine->id) }}" class="mt-1 inline-flex items-center text-sm font-medium text-blue-500 hover:text-indigo-600 transition duration-150 ease-in-out">
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50">
                            <tr class="text-left text-gray-900 font-semibold">
                                ...
                                <th class="px-6 py-3 whitespace-nowrap">Beneficiary</th>
                        ...
                        <tbody class="divide-y">
                            @forelse ($payouts as $index => $payout)
                                <tr class="fade-in transition duration-150 hover:bg-gray-50" style="animation-delay: {{ $index * 50 }}ms">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $payout->beneficiary->name ?? 'Unknown' }}</td>
