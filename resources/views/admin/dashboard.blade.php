    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-blue-500 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-blue-50">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-purple-500 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-purple-50">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-green-500 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-green-50">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-gray-400 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-gray-50">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-indigo-500 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-indigo-50">
                ...
                <div class="group bg-white shadow-sm rounded-lg p-6 border-l-4 border-amber-500 transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:bg-amber-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white shadow-sm rounded-lg p-6 transition-all duration-300 ease-out hover:shadow-lg">
                    <h3 class="font-semibold mb-3">Recent Tontines</h3>
                    <ul class="divide-y">
                        @foreach ($recentTontines as $t)
                            <li class="py-2 text-sm rounded-md transition-colors duration-200 hover:bg-blue-50 hover:px-2">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 transition-all duration-300 ease-out hover:shadow-lg">
                    ...
                    <ul class="divide-y">
                        @foreach ($recentUsers as $u)
                            <li class="py-2 text-sm rounded-md transition-colors duration-200 hover:bg-purple-50 hover:px-2">
