            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div x-data="{ showPassword: false }">
                    ...
                    <div class="relative mt-1">
                        ...
                        <!-- Eye SVG Icon Toggle -->
                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-300 hover:text-balck transition-colors">
                ...
                <div class="text-center mt-4 pt-1">
                    <p class="text-xs text-gray-300/90">
                        ...
                        <a href="{{ route('register') }}" class="font-bold text-white hover:underline ml-1">Signup</a>
                    </p>
                </div>
            </form>
        </div>
